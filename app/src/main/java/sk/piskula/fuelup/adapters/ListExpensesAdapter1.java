 ...
 */
public class ListExpensesAdapter1 extends RecyclerView.Adapter<ListExpensesAdapter1.ViewHolder> {
    ...
    public ListExpensesAdapter1(Context context, Callback callback, List<Expense> items) {
        super();

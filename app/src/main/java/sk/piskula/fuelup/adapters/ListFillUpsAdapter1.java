...
public class ListFillUpsAdapter1 extends RecyclerView.Adapter<ListFillUpsAdapter1.ViewHolder> {

    private List<FillUp> items;
    private Callback callback;


    public ListFillUpsAdapter1(Callback callback, List<FillUp> items) {
        super();
        this.items = items;

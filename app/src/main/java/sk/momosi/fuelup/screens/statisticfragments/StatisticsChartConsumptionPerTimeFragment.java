...
import sk.momosi.fuelup.databinding.FragmentStatisticsChartConsumptionPerTimeBinding;
import sk.momosi.fuelup.entity.Vehicle;
import sk.momosi.fuelup.loaders.ConsumptionPerMonthChartDataLoader;
...
public class StatisticsChartConsumptionPerTimeFragment extends Fragment implements LoaderManager.LoaderCallbacks<Map<String, Object>> {
    ...
    public Loader<Map<String, Object>> onCreateLoader(int id, Bundle args) {
        ...
        return new ConsumptionPerMonthChartDataLoader(getActivity(), vehicleId, new FillUpService(), new StatisticsService(getContext(), vehicleId));
    }
